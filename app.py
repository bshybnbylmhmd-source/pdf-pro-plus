...
<head>
    ...
    <style>
        ...
        .grid { display: grid; grid-template-columns: repeat(auto-fit, minmax(160px, 1fr)); gap: 10px; align-items: start; }
        ...
        input[type="file"], input[type="text"], input[type="number"] { width: 95%; padding: 5px; margin: 5px 0; font-size: 10px; border: 1px solid #ccc; border-radius: 4px; box-sizing: border-box; }
        ...
        footer { text-align: center; margin-top: 20px; font-size: 10px; color: #7f8c8d; clear: both; }
    </style>
</head>
<body>
    ...
    <div class="grid">
        ...
        <div class="card"><h3>استخراج نص صفحة</h3><form action="/process" method="POST" enctype="multipart/form-data"><input type="hidden" name="tool" value="extract_page_text"><input type="file" name="pdf" required><input type="number" name="page" placeholder="رقم الصفحة" required><button>استخراج النص</button></form></div>
        <div class="card"><h3>فحص بنية الملف</h3><form action="/process" method="POST" enctype="multipart/form-data"><input type="hidden" name="tool" value="verify_structure"><input type="file" name="pdf" required><button>فحص البنية</button></form></div>
        <div class="card"><h3>فحص اتجاه الصفحة</h3><form action="/process" method="POST" enctype="multipart/form-data"><input type="hidden" name="tool" value="check_orientation"><input type="file" name="pdf" required><button>فحص الاتجاه</button></form></div>
        <div class="card"><h3>إصدار ملف الـ PDF</h3><form action="/process" method="POST" enctype="multipart/form-data"><input type="hidden" name="tool" value="pdf_version"><input type="file" name="pdf" required><button>معرفة الإصدار</button></form></div>
        <div class="card"><h3>حساب عدد الصفحات</h3><form action="/process" method="POST" enctype="multipart/form-data"><input type="hidden" name="tool" value="page_count"><input type="file" name="pdf" required><button>حساب الصفحات</button></form></div>
        <div class="card"><h3>ملخص حالة الملف</h3><form action="/process" method="POST" enctype="multipart/form-data"><input type="hidden" name="tool" value="pdf_summary"><input type="file" name="pdf" required><button>عرض الملخص</button></form></div>
        <div class="card"><h3>تقسيم الملف</h3><form action="/process" method="POST" enctype="multipart/form-data"><input type="hidden" name="tool" value="split_pdf"><input type="file" name="pdf" required><button>تقسيم الملف</button></form></div>
        <div class="card"><h3>صور إلى PDF</h3><form action="/process" method="POST" enctype="multipart/form-data"><input type="hidden" name="tool" value="images_to_pdf"><input type="file" name="pdf" multiple required><button>تحويل الصور</button></form></div>
        <div class="card"><h3>إضافة علامة مائية</h3><form action="/process" method="POST" enctype="multipart/form-data"><input type="hidden" name="tool" value="watermark"><input type="file" name="pdf" required><input type="text" name="text" placeholder="نص العلامة" required><button>إضافة العلامة</button></form></div>
        <div class="card"><h3>استخراج الصور</h3><form action="/process" method="POST" enctype="multipart/form-data"><input type="hidden" name="tool" value="extract_images"><input type="file" name="pdf" required><button>استخراج الصور</button></form></div>
        <div class="card"><h3>استخراج الروابط</h3><form action="/process" method="POST" enctype="multipart/form-data"><input type="hidden" name="tool" value="extract_links"><input type="file" name="pdf" required><button>استخراج الروابط</button></form></div>
        <div class="card"><h3>إعادة ترتيب الصفحات</h3><form action="/process" method="POST" enctype="multipart/form-data"><input type="hidden" name="tool" value="reorder"><input type="file" name="pdf" required><input type="text" name="order" placeholder="مثال: 3,1,2" required><button>إعادة الترتيب</button></form></div>
        <div class="card"><h3>فحص التشفير</h3><form action="/process" method="POST" enctype="multipart/form-data"><input type="hidden" name="tool" value="check_encrypted"><input type="file" name="pdf" required><button>فحص الحالة</button></form></div>
        <div class="card"><h3>تحديث المؤلف</h3><form action="/process" method="POST" enctype="multipart/form-data"><input type="hidden" name="tool" value="set_author"><input type="file" name="pdf" required><input type="text" name="author" placeholder="اسم المؤلف" required><button>تحديث المؤلف</button></form></div>
        <div class="card"><h3>تصدير إلى TXT</h3><form action="/process" method="POST" enctype="multipart/form-data"><input type="hidden" name="tool" value="export_txt"><input type="file" name="pdf" required><button>تصدير النص</button></form></div>
        <div class="card"><h3>التحقق من محتوى الملف</h3><form action="/process" method="POST" enctype="multipart/form-data"><input type="hidden" name="tool" value="verify_not_empty"><input type="file" name="pdf" required><button>التحقق</button></form></div>
        <div class="card"><h3>حذف خصائص الملف</h3><form action="/process" method="POST" enctype="multipart/form-data"><input type="hidden" name="tool" value="remove_metadata"><input type="file" name="pdf" required><button>حذف الخصائص</button></form></div>
        <div class="card"><h3>البحث عن نص</h3><form action="/process" method="POST" enctype="multipart/form-data"><input type="hidden" name="tool" value="search_text"><input type="file" name="pdf" required><input type="text" name="keyword" placeholder="كلمة البحث" required><button>بحث</button></form></div>
